---
title: "Microsoft 365 Certified Security Administrator Associate"
pubDatetime: 2021-01-30T00:00:00Z
modDatetime: 2021-01-30T00:00:00Z
featured: false
draft: false
tags:
  - "Achievements"
...
The exam duration was 3 hours, although one could finish ahead in time depending on the total number of questions, which is expected to be around 40-50. A combination of multiple choice, choose the right answer, choose and reorder type of questions were a few that appeared on the exam. Going through the skills measured as listed on the exam [page](https://docs.microsoft.com/en-us/learn/certifications/exams/ms-500) will definitely help to review whether you have covered all the topics. I am greatly thankful to all those who have made resources available for this course and those who provided study guides and easy links to various topics on the Microsoft documentation site. I am sharing the resources I have used to learn and prepare for this exam (all credits to their respective owners):

- Microsoft [webinars](https://partner.microsoft.com/en-us/training/assets/collection/microsoft-365-security-administrator-associate-certification-exam-ms-500#/)
- Udemy course by John Christopher [here](https://www.udemy.com/course/ms-500examlabpractice/)
- Microsoft mechanics YouTube videos [here](https://www.youtube.com/playlist?list=PLXtHYVsvn_b9JT5sR8tEA5DeaTcS9fCtF)
- Microsoft learning path [here](https://docs.microsoft.com/en-us/learn/certifications/m365-security-administrator#certification-exam-disclaimers)
- Mark O’Shea blog post [here](https://intunedin.net/2020/06/29/preparing-for-the-ms-500-microsoft-365-security-administration-exam-june-2020-update/)
- Exam guide by Chris Hoard [here](https://microsoft365pro.co.uk/2019/04/15/microsoft-365-security-administration-ms-500-exam-prep-guide/)
