...
1. Personal: This refers to your personal/primary email account. The one that you mostly use for signing up to your social media accounts, subscribe to any magazines, the one that you put on your resume or the one that you use while opening a bank account.
2. Professional: This refers to the email account provided to you by your organisation/employer. These emails are generally not used for signing up for a magazine subscription, opening up a social media account or giving to a family member to share something personal with you.
...
2. Enable 2FA (wherever applicable)
...
This is comparatively a straightforward activity to enable 2FA on your email account(s). Most email providers allow setting up 2FA with the app of your choice, but they are mostly turned off by default. Some of the widely popular applications to set up 2FA are Aegis, Google Authenticator, Authy, Microsoft Authenticator (for Microsoft accounts) or any password management tool that has the TOTP (Time-based OTP) functionality (Proton Pass for example).
